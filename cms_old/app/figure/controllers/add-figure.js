...
myApp.controller('AddFigureCtrl', ['$scope','$rootScope','$timeout','figureService','$location', function($scope,$rootScope,$timeout,figureService,$location) {
