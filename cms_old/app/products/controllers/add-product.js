...
myApp.controller('AddProductCtrl', ['$scope','$rootScope','$timeout','productService','$location','categoryService', function($scope,$rootScope,$timeout,productService,$location,categoryService) {
